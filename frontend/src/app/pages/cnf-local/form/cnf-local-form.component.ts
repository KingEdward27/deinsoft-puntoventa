...
@Component({
  selector: 'app-cnf-local-form',
  templateUrl: './cnf-local-form.component.html',
  styleUrls: ['./cnf-local-form.component.css']
})
export class CnfLocalFormComponent implements OnInit{
  ...
  //variables propias
  public model : CnfLocal = new CnfLocal();
...
loadingCnfEmpresa: boolean = false;
  protected redirect: string = "/cnf-local";
  selectedOption:any;
  passwordRepeat:any;

  constructor(private cnfLocalService:CnfLocalService, 
  ...
  loadData(){
    ...
    return this.route.paramMap.subscribe(params => {
      ...
      if(this.id){
        this.cnfLocalService.getData(this.id).subscribe(data => {
          this.model = data;
  ...
  public save(): void {
    this.cnfLocalService.save(this.model).subscribe(m => {
      console.log(m);
      this.isOk = true;
