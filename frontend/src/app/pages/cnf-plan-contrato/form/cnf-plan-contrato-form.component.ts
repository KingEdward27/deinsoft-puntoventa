...
@Component({
  selector: 'app-cnf-plan-contrato-form',
  templateUrl: './cnf-plan-contrato-form.component.html',
  styleUrls: ['./cnf-plan-contrato-form.component.css']
})
export class CnfPlanContratoFormComponent implements OnInit{
  ...
  //variables propias
  public model : CnfPlanContrato = new CnfPlanContrato();
...
loadingCnfEmpresa: boolean = false;
  protected redirect: string = "/cnf-plan-contrato";
  selectedOption:any;
  passwordRepeat:any;

  constructor(private cnfPlanContratoService:CnfPlanContratoService, 
  ...
  loadData(){
    ...
    return this.route.paramMap.subscribe(params => {
      ...
      if(this.id){
        this.cnfPlanContratoService.getData(this.id).subscribe(data => {
          this.model = data;
  ...
  public save(): void {
    this.cnfPlanContratoService.save(this.model).subscribe(m => {
      console.log(m);
      this.isOk = true;
