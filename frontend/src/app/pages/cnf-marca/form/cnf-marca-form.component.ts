...
@Component({
  selector: 'app-cnf-marca-form',
  templateUrl: './cnf-marca-form.component.html',
  styleUrls: ['./cnf-marca-form.component.css']
})
export class CnfMarcaFormComponent implements OnInit{
  ...
  //variables propias
  public model : CnfMarca = new CnfMarca();
...
loadingCnfEmpresa: boolean = false;
  protected redirect: string = "/cnf-marca";
  selectedOption:any;
  passwordRepeat:any;

  constructor(private cnfMarcaService:CnfMarcaService, 
  ...
  loadData(){
    ...
    return this.route.paramMap.subscribe(params => {
      ...
      if(this.id){
        this.cnfMarcaService.getData(this.id).subscribe(data => {
          this.model = data;
  ...
  public save(): void {
    this.cnfMarcaService.save(this.model).subscribe(m => {
      console.log(m);
      this.isOk = true;
