...
export class CnfCategoriaComponent extends GenericListComponent implements OnInit{
  ...
  prop ={
    "tableName": "cnf_zona",
    "title": "Categorías",
    "columnsList":[{tableName: "cnf_zona", columnName:"nombre",filterType:"text"}
                ],
    "columnsForm":[{tableName: "cnf_zona", "columnName":"nombre","type":"input"}
           ],
  ...
  ngOnInit(): void {
    ...
    this.prop.conditions.push({"columnName":"cnf_zona.cnf_empresa_id","value":cnfEmpresa});
