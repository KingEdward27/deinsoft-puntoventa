...
export class CnfPlanContratoComponent extends GenericListComponent implements OnInit {
  ...
  prop = {
    ...
    "columnsList": [{ tableName: "cnf_plan_contrato", columnName: "nombre", filterType: "text" },
                    { tableName: "cnf_plan_contrato", columnName: "precio_instalacion", filterType: "text", type: "number", format: "currency" },
                    { tableName: "cnf_plan_contrato", columnName: "precio", filterType: "text", type: "number", format: "currency" },
                    { tableName: "cnf_plan_contrato", columnName: "dia_proceso_corte", type: "input" },
                    { tableName: "cnf_plan_contrato", columnName: "dia_vencimiento", type: "number", filterType: "none" }],
    ...
    "columnsForm": [{ tableName: "cnf_plan_contrato", columnName: "nombre", type: "input" },
                    { tableName: "cnf_plan_contrato", columnName: "precio_instalacion", type: "input" },
