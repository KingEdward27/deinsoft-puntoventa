...
export class DashboardComponent implements OnInit {
    ...
    totalMontoPagos:any
    constructor(private actContratoService: ActContratoService, private appService: AppService) {
    }

    ngOnInit(): void {
        let empresaPrincipal = this.appService.getProfile().empresaPrincipal;
        if (empresaPrincipal == 2) {
