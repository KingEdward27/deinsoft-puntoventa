...
@Component({
  selector: 'app-inv-movimiento-producto-report',
  templateUrl: './inv-movimiento-producto-report.component.html',
  providers: [
...
export class InvMovimientoProductoReportFormComponent extends CommonReportFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleExport = "Reporte de Kardex Valorizado"
    super.ngOnInit();
    //this.getListData();
  }
  getListData() {
