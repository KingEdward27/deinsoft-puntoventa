...
@Component({
  selector: 'app-inv-almacen-report',
  templateUrl: './inv-almacen-report.component.html',
  providers: [
...
export class InvAlmacenReportFormComponent extends CommonReportFormComponent implements OnInit {
