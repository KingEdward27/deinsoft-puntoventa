...
@Component({
  selector: 'app-add-new-cnf-paquete-almacen-det',
  templateUrl: './add-new-cnf-paquete-det.component.html'
,
  providers: [
...
export class AddNewCnfPaqueteDetComponent implements OnInit {
