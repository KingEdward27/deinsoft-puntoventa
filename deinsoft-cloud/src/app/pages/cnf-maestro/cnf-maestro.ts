...
export class CnfMaestroComponent extends GenericListComponent implements OnInit{
  ...
  prop ={
    ...
    "columnsList":[{tableName: "cnf_tipo_documento",columnName:"nombre",filterType:"none"},
    ...
    "columnsForm":[{tableName: "cnf_tipo_documento", "columnName":"nombre","type":"select",loadState : 1,relatedBy:"cnf_tipo_documento_id"},
