...
-- --------------------------------------------------------
--
-- Volcar la base de datos para la tabla `cnf_nombre`
--
...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `cnf_distrito_id`
--
INSERT INTO `cnf_distrito` (`cnf_distrito_id`, `nombre`, `cnf_provincia_id`) VALUES
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
