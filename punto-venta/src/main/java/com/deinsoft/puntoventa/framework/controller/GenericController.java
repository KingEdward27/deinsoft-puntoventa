...
//        }
    ...
    public String exportToExcel(@RequestBody Detail objectList, HttpServletResponse response) throws IOException, IllegalArgumentException, IllegalAccessException {
...
//        }
        ExportUtil excelExporter = new ExportUtil(objectList.getFilters(),cabecera,arrayVisibleObjects);
