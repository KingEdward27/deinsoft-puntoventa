...
@Service
@Transactional
public class CnfImpuestoCondicionServiceImpl extends CommonServiceImpl<CnfImpuestoCondicion,Long,CnfImpuestoCondicionRepository> implements CnfImpuestoCondicionService  {
	@Autowired 
