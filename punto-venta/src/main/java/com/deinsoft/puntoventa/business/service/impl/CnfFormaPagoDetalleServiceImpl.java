...
@Service
@Transactional
public class CnfFormaPagoDetalleServiceImpl extends CommonServiceImpl<CnfFormaPagoDetalle,Long, CnfFormaPagoDetalleRepository> implements CnfFormaPagoDetalleService {
