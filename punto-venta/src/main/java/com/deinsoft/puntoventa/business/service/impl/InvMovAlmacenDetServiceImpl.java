...
@Service
@Transactional
public class InvMovAlmacenDetServiceImpl extends CommonServiceImpl<InvMovAlmacenDet,Long, InvMovAlmacenDetRepository> implements InvMovAlmacenDetService {
