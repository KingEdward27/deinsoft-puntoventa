...
public class CnfDistrito implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_distrito_id")
	@SequenceGenerator(name="seq_cnf_distrito_id", sequenceName = "seq_cnf_distrito_id",allocationSize=1)
