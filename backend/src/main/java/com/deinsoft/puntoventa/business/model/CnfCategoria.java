...
public class CnfCategoria implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_categoria_id")
	@SequenceGenerator(name="seq_cnf_categoria_id", sequenceName = "seq_cnf_categoria_id",allocationSize=1)
