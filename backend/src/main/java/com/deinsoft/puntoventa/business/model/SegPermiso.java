...
public class SegPermiso implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_seg_permiso_id")
	@SequenceGenerator(name="seq_seg_permiso_id", sequenceName = "seq_seg_permiso_id",allocationSize=1)
