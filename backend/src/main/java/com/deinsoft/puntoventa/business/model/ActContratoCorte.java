...
public class ActContratoCorte implements Serializable{
	...
	@Size(max = 1)
	@Column(name="flg_estado", length = 1, nullable = true)
	...
	public String toString() {
		return "actContratoCorte [id=" + id + ", actContrato=" + (actContrato!=null?actContrato:"") + ", fecha=" + fecha + ", flgEstado=" + flgEstado + ", segUsusarioId=" + segUsusarioId + "]";	}
