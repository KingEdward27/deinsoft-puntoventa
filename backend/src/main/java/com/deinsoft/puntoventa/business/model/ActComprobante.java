...
public class ActComprobante implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_act_comprobante_id")
	@SequenceGenerator(name="seq_act_comprobante_id", sequenceName = "seq_act_comprobante_id",allocationSize=1)
