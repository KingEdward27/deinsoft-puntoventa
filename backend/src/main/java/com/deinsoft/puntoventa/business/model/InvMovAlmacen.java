...
public class InvMovAlmacen implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_inv_mov_almacen_id")
	@SequenceGenerator(name="seq_inv_mov_almacen_id", sequenceName = "seq_inv_mov_almacen_id",allocationSize=1)
	...
	@JsonFormat(pattern = "dd-MM-yyyy")
	@Column(name="fechareg", length = 0, nullable = true)
	...
	public String toString() {
		return "invMovAlmacen [id=" + id + ", cnfLocal=" + (cnfLocal!=null?cnfLocal:"") + ", cnfMaestro=" + (cnfMaestro!=null?cnfMaestro:"") + ", cnfTipoComprobante=" + (cnfTipoComprobante!=null?cnfTipoComprobante:"") + ", invAlmacen=" + (invAlmacen!=null?invAlmacen:"") + ", invTipoMovAlmacen=" + (invTipoMovAlmacen!=null?invTipoMovAlmacen:"") + ", segUsuario=" + (segUsuario!=null?segUsuario:"") + ", serie=" + serie + ", numero=" + numero + ", numeroRef=" + numeroRef + ", fecha=" + fecha + ", observacion=" + observacion + ", subtotal=" + subtotal + ", igv=" + igv + ", total=" + total + ", fechareg=" + fechareg + ", flagEstado=" + flagEstado + "]";	}
