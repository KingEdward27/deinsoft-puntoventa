...
public class CnfFormaPago implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_forma_pago_id")
	@SequenceGenerator(name="seq_cnf_forma_pago_id", sequenceName = "seq_cnf_forma_pago_id",allocationSize=1)
