...
public class CnfMaestro implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_maestro_id")
	@SequenceGenerator(name="seq_cnf_maestro_id", sequenceName = "seq_cnf_maestro_id",allocationSize=1)
	@Column(name="cnf_maestro_id",nullable = false, unique = true)
	private long id;
