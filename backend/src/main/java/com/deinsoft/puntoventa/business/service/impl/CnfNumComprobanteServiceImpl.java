...
@Service
@Transactional
public class CnfNumComprobanteServiceImpl extends CommonServiceImpl<CnfNumComprobante,CnfNumComprobanteRepository> implements CnfNumComprobanteService  {
	@Autowired 
	...
	public List<CnfNumComprobante> getAllCnfNumComprobanteByCnfTipoComprobante(long id) {
		List<CnfNumComprobante> CnfNumComprobanteList = (List<CnfNumComprobante>)cnfNumComprobanteRepository.findByCnfTipoComprobanteId(id);
		return CnfNumComprobanteList;
	}
