...
public class InvMovAlmacenDet implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_inv_mov_almacen_det_id")
	@SequenceGenerator(name="seq_inv_mov_almacen_det_id", sequenceName = "seq_inv_mov_almacen_det_id",allocationSize=1)
