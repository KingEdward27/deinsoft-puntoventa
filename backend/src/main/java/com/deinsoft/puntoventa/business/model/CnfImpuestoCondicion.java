...
public class CnfImpuestoCondicion implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_impuesto_condicion_id")
	@SequenceGenerator(name="seq_cnf_impuesto_condicion_id", sequenceName = "seq_cnf_impuesto_condicion_id",allocationSize=1)
