...
public class CnfPais implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_pais_id")
	@SequenceGenerator(name="seq_cnf_pais_id", sequenceName = "seq_cnf_pais_id",allocationSize=1)
