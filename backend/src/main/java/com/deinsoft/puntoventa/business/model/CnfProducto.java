...
public class CnfProducto implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_producto_id")
	@SequenceGenerator(name="seq_cnf_producto_id", sequenceName = "seq_cnf_producto_id",allocationSize=1)
