...
public class ActComprobanteDetalle implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_act_comprobante_detalle_id")
	@SequenceGenerator(name="seq_act_comprobante_detalle_id", sequenceName = "seq_act_comprobante_detalle_id",allocationSize=1)
