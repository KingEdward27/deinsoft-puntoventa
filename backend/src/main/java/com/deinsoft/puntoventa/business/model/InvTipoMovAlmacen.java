...
public class InvTipoMovAlmacen implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_inv_tipo_mov_almacen_id")
	@SequenceGenerator(name="seq_inv_tipo_mov_almacen_id", sequenceName = "seq_inv_tipo_mov_almacen_id",allocationSize=1)
