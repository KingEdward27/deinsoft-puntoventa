...
public class CnfLocal implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cnf_local_id")
	@SequenceGenerator(name="seq_cnf_local_id", sequenceName = "seq_cnf_local_id",allocationSize=1)
